...
case 'wallml':{
    ...
    fs.writeFileSync(`./media/image/anime/${sender}.jpeg`, await getBuffer(wipi))
    const gambra = await TEX.prepareMessage(from, fs.readFileSync(`./media/image/anime/${sender}.jpeg`), MessageType.image, {thumbnail: fakeimage})
    ...
    await TEX.sendMessage(from, ButtonsMessages, MessageType.buttonsMessage, {quoted : mek})
    fs.unlinkSync(`./media/image/anime/${sender}.jpeg`)
    }
    break
